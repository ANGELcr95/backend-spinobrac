      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.prev = 1;
            _req$body = req.body, dni = _req$body.dni, password = _req$body.password;
            _context.next = 5;
          ...
          case 5:
            ...
            _context.next = 8;
            return connection.query('SELECT * FROM workers WHERE document_number = ?', [dni]);

          case 8:
            _yield$connection$que = _context.sent;
            _yield$connection$que2 = _slicedToArray(_yield$connection$que, 1);
            dataWorker = _yield$connection$que2[0];
            connection.end();
